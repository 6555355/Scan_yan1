...
namespace BYHXPrinterManager.Main
{
    partial class MainForm
    {
        ...
        private TcpIpCmdFhzl _curCmdFhzl = TcpIpCmdFhzl.GetInfo;
        void remoteControlServerTask_ProgressChanged(object sender, ProgressChangedEventArgs e)
        {
            try
            {
                ProtocolFhzl protocol = (ProtocolFhzl)e.UserState;
                    ...
                    case 0:
                        {
                            ...
                            switch (protocol.Cmd)
                            {
                                case TcpIpCmdFhzl.EndPackage:
                                    {
                                        ProcessEndPackageCmd(protocol);
                                        break;
                                    }
                                case TcpIpCmdFhzl.ResponsePackage:
                                    break;
                                case TcpIpCmdFhzl.GetInfo:
                                    {
                                        ProcessGetInfoCmd(protocol);
                                        break;
                                    }
                                case TcpIpCmdFhzl.OprationCmd:
                                    {
                                        ProcessOprationCmd(protocol);
                                        break;
                                    }
                                case TcpIpCmdFhzl.PrintParameter:
                                    {
                                        ProcessPrintParameterCmd(protocol);
                                        break;
                                    }
                                case TcpIpCmdFhzl.PrinterSetting:
                                    {
                                        ProcessPrinterSettingCmd(protocol);
                                        break;
                                    }
                                case TcpIpCmdFhzl.ColorBarSetting:
                                    {
                                        ProcessColorBarSettingCmd(protocol);
                                        break;
                                    }
                                case TcpIpCmdFhzl.SpraySetting:
                                    {
                                        ProcessSpraySettingCmd(protocol);
                                        break;
                                    }
                                case TcpIpCmdFhzl.PrintDir:
                                    {
                                        ProcessPrintDirCmd(protocol);
                                        break;
                                    }
                                case TcpIpCmdFhzl.PreferenceSetting:
                                    {
                                        ProcessPreferenceSettingCmd(protocol);
                                        break;
                                    }
                                case TcpIpCmdFhzl.CaribrationHor:
                                case TcpIpCmdFhzl.CaribrationStep:
                                //case TcpIpCmdFhzl.CaribrationVer:
                                //case TcpIpCmdFhzl.CaribrationOverLap:
                                    {
                                        ProcessCaribrationCmd(protocol);
                                        break;
                                    }
                                //case TcpIpCmdFhzl.FactoryDebug:
                                //    {
                                //        ProcessFactoryDebugCmd(protocol);
                                //        break;
                                //    }
                                    case TcpIpCmdFhzl.SystemSetting:
                                {
                            ...
                            if (_curCmdFhzl != protocol.Cmd && protocol.Cmd!=TcpIpCmdFhzl.GetInfo)
        ...
        private void ProcessSystemSettingCmd(ProtocolFhzl protocol)
        {
        ...
        private void ProcessEndPackageCmd(ProtocolFhzl protocol)
        {
            ProtocolFhzl returnFhzl = new ProtocolFhzl(TcpIpCmdFhzl.ResponsePackage, (byte)TcpIpCmdFhzl.ResponsePackage, protocol.Parameter);// 偷懒直接返回了数量,应该自己计数...
        ...
        /// </summary>
        /// <param name="protocol"></param>
        private void ProcessGetInfoCmd(ProtocolFhzl protocol)
        {
            switch ((GetInfoSubCmd)protocol.SubCmd)
            {
                ...
                case GetInfoSubCmd.ErrorCode: //3：错误代码
                    {
                        ProtocolFhzl returnFhzl = new ProtocolFhzl(TcpIpCmdFhzl.ResponsePackage,
                          (byte)GetInfoSubCmd.ErrorCode, _errorCode.ToString("H8"));
                        remoteControlServer.SendCmdReturnValue(returnFhzl);
                        break;
                    }
                case GetInfoSubCmd.JobSize: //4：打印任务详细信息
                    {
                        ...
                        if (job != null)
                        {
                            ...
                            ProtocolFhzl returnFhzl = new ProtocolFhzl(TcpIpCmdFhzl.ResponsePackage, protocol.SubCmd, jobsize);
                            remoteControlServer.SendCmdReturnValue(returnFhzl);
                        }
                        else
                        {
                            ProtocolFhzl returnFhzl = new ProtocolFhzl(TcpIpCmdFhzl.ResponsePackage, protocol.SubCmd, "");
                            remoteControlServer.SendCmdReturnValue(returnFhzl);
                        }
                        break;
                    }
                ...
                case GetInfoSubCmd.PrintMode: //4：打印任务详细信息
                    {
                        ...
                        {
                            //6：打印模式	参数未知
                            ProtocolFhzl returnFhzl = new ProtocolFhzl(TcpIpCmdFhzl.ResponsePackage, protocol.SubCmd, job.ColorDeep.ToString());
                            remoteControlServer.SendCmdReturnValue(returnFhzl);
                        }
                        else
                        {
                ...
                case GetInfoSubCmd.PrintPass: //4：打印任务详细信息
                    {
                        ...
                        {
                            //7：扫描次数（每Pass的扫描次数）
                            ProtocolFhzl returnFhzl = new ProtocolFhzl(TcpIpCmdFhzl.ResponsePackage, protocol.SubCmd, job.PassNumber.ToString());
                            remoteControlServer.SendCmdReturnValue(returnFhzl);
                        }
                        else
                        {
                ...
                case GetInfoSubCmd.ScanMode: //4：打印任务详细信息
                    {
                        ...
                        {
                            //8：扫描模式	单向值为1，双向值为2
                            ProtocolFhzl returnFhzl = new ProtocolFhzl(TcpIpCmdFhzl.ResponsePackage, protocol.SubCmd, (job.PrintingDirection + 1).ToString());
                            remoteControlServer.SendCmdReturnValue(returnFhzl);
                        }
                        else
                        {
                ...
                case GetInfoSubCmd.JobPath: //4：打印任务详细信息
                    {
                        ...
                        {
                            //9：任务地址	文件路径
                            ProtocolFhzl returnFhzl = new ProtocolFhzl(TcpIpCmdFhzl.ResponsePackage, protocol.SubCmd, job.FileLocation);
                            remoteControlServer.SendCmdReturnValue(returnFhzl);
                        }
                        else
                        {
                ...
                case GetInfoSubCmd.ToolbarStepAdjust: //4：打印任务详细信息
                    {
                        ...
                        else
                        {
                            if (ss.nKillBiDirBanding != 0)
                                step = ss.sCalibrationSetting.nPassStepArray[(ss.sFrequencySetting.nPass + 1) / 2 - 1] = step;
                            else
                                step = ss.sCalibrationSetting.nPassStepArray[ss.sFrequencySetting.nPass - 1] = step;
                        }
        ...
        /// </summary>
        /// <param name="protocol"></param>
        private void ProcessOprationCmd(ProtocolFhzl protocol)
        {
        ...
        private void ProcessPrintParameterCmd(ProtocolFhzl protocol)
        {
            SPrinterSetting ss = m_allParam.PrinterSetting;
        ...
        private void ProcessPrinterSettingCmd(ProtocolFhzl protocol)
        {
            SPrinterSetting ss = m_allParam.PrinterSetting;
        ...
        private void ProcessColorBarSettingCmd(ProtocolFhzl protocol)
        {
            SPrinterSetting ss = m_allParam.PrinterSetting;
        ...
        private void ProcessSpraySettingCmd(ProtocolFhzl protocol)
        {
            SPrinterSetting ss = m_allParam.PrinterSetting;
        ...
        private void ProcessPrintDirCmd(ProtocolFhzl protocol)
        {
            SPrinterSetting ss = m_allParam.PrinterSetting;
        ...
        private void ProcessPreferenceSettingCmd(ProtocolFhzl protocol)
        {
        ...
        private void ProcessCaribrationCmd(ProtocolFhzl protocol)
        {
            SPrinterSetting ss = m_allParam.PrinterSetting;
        ...
        private void ProcessFactoryDebugCmd(ProtocolFhzl protocol)
        {
        ...
        {
            remoteControlServer.Worker = (sender as BackgroundWorker);
