...
namespace BYHXPrinterManager.TcpIp
{
	...
	public class BackgroundWorker
	{
		...
		public void ReportProgress(int percent,object para)
		{
			if(WorkerReportsProgress)
			{
				ProgressChangedEventArgs progressArgs;
				progressArgs = new ProgressChangedEventArgs(percent,para);                  
		...
		public void ReportProgress(int percent)
		{
			...
			{
				ProgressChangedEventArgs progressArgs;
				progressArgs = new ProgressChangedEventArgs(percent,null);                  
				OnProgressChanged(progressArgs);
			}
		}
	...
	public class ProgressChangedEventArgs : EventArgs
	{
		...
		public readonly object Para;
		public ProgressChangedEventArgs (int intProgressPercentage,object para)
		{
