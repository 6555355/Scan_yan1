...
namespace BYHXPrinterManager.GradientControls 
{
	...
	public class DropDownPanel : System.Windows.Forms.Panel 
	{
		...
		public DropDownPanel() 
		{
			...
			pnlHeader.Layout +=new LayoutEventHandler(pnlHeader_Layout);
...
//			BringToFront();
		...
		private void pnlHeader_Layout(object sender, LayoutEventArgs e)
		{
		...
		/// </summary>
		[Category("Appearance"),Description("The image shown in the Header in normal status. Height must be less than HeaderHeight - 4 pixels. Null to disable it.")]
		...
		/// </summary>
		[Category("Appearance"),Description("The image shown in the Header in HotTrack status. Height must be less than HeaderHeight - 4 pixels. Null to disable it.")]
		...
		/// </summary>
		[Category("Appearance"),Description("Gets or sets the Font used in the Header.")]
		...
		/// </summary>
		[Category("Appearance"),Description("Gets or sets the status of the DropDownPanel.")]
		...
		/// </summary>
		[Category("Appearance"),Description("Gets or sets the Header's Height of the DropDownPanel. The min value is 16, the max value is 48.")]
		...
		/// </summary>
		[Category("Appearance"),Description("Gets or sets if the Header can show its ContextMenu with some options by right-clicking on it.")]
		...
		/// </summary>
		[Category("Appearance"),Description("Gets or sets the Expand/Collapse Animation Speed."), Editor(typeof(AnimationSpeedEditor), typeof(UITypeEditor))]
		...
		/// </summary>
		[Category("Appearance"),Description("Gets or sets the style of the HotTrack for the Header."), Editor(typeof(HotTrackStyleEditor), typeof(UITypeEditor))]
		...
		/// </summary>
		[Category("Appearance"),Description("Gets or sets if the corners of the DropDownPanel must be drawn rounded.")]
		...
		/// </summary>
		[Category("Appearance"),Localizable(true), Description("Gets or sets the Text of the DropDownPanel Header.")]
		...
		/// </summary>
		[Category("Appearance"),Description("The home Location of the DropDownPanel, used when its location is restored.")]
		...
		/// </summary>
		[Category("Appearance"),Description("Gets or sets the AutoCollapse Delay in milliseconds. Use negative values to disable this function.")]
		...
		/// </summary>
		[Category("Appearance"),Description("Gets or sets if the DropDownPanel has to manage the specified Controls.")]
		...
		/// </summary>
		[Category("Appearance"),Description("Gets or sets if the DropDownPanel can be moved by dragging its Header.")]
		...
		public BYHXPrinterManager.Style HeaderGradientColors
		{
			get{return this.pnlHeader.GradientColors;}
			set
			{
				this.pnlHeader.GradientColors = value;
				pnlHeader.Invalidate();
				pnlHeader.Update();
			}
		}
		...
		{
			get { return this.pnlHeader.TreeColorGradient; }
			set
			{
				this.pnlHeader.TreeColorGradient = value;
				pnlHeader.Invalidate();
			}
		}
		...
		{
			get { return this.pnlHeader.GradientMode; }
			set
			{
				if (value != this.pnlHeader.GradientMode)
				{
					this.pnlHeader.GradientMode = value;
					pnlHeader.Invalidate();
				}
			}
		}
		...
		{
			get { return this.pnlHeader.TransparentMode; }
			set
			{
				if (value != this.pnlHeader.TransparentMode)
				{
					this.pnlHeader.TransparentMode = value;
					pnlHeader.Invalidate();
				}
			}
		}
	...
	/// </summary>
	public class FlickerFreePanel : BYHXPrinterManager.GradientControls.CrystalPanel  
	{
