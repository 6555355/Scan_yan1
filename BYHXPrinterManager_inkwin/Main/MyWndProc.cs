...
#endif
				imgbackground_main = Image.FromFile(Application.StartupPath + "\\Skins\\newBlue\\background_main.png");
				imgbackground = Image.FromFile(Application.StartupPath + "\\Skins\\newBlue\\background.png");
#if USETHEME
				loadSucessed = true;
#else
				return true;
